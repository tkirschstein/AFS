...
\usepackage[hyphens]{url}
  ...
  \journal{Journal of Industrial Ecology} % Sets Journal name
...
\begin{frontmatter}
  ...
  \end{abstract}
    \begin{keyword}
    Industrial symbiosis \sep Agroforestry \sep Biomass cascading \sep Bioeconomy network \sep Material flow optimisation \sep 
    Cleaner production
  \end{keyword}
...
\citep{Toensmeier2017_Carbon_Agroforestry}. This biological-industrial
...
cleaner production perspective \citep{Huber2018_SRAFS_growth}.
...
land \citep{DEFAF}. This gap between potential and practice reflects an
...
material rises markedly \citep{Huber2018_SRAFS_growth, Niemczyk2021_Poplar_Rotation}. The material flow structure of an
...
\citep{Zahraee2020_BSC_review, DeMeyer2016_tOPTIMASS}.
