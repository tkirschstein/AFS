...
models, reviewed in Section \autoref{sec:lit-sc}, do not capture this
...
Section \autoref{sec:litreview} reviews the relevant literature on
...
here. Section \autoref{sec:milp} presents the AFS-SCD formulation.
Section \autoref{sec-casestudy} describes the Saxony-Anhalt case study,
...
production strategies. Section \autoref{sec:conclusion} concludes and
...
The author is responsible to contents of this text.

# Acknowledgments {.bm .unnumbered}

This research was carried out within the project “DiP: SMART-Agroforst – Digitalisierung zur Förderung der Etablierung von Agroforstsystemen auf der Landschaftsebene als Beitrag zur Klimaresilienz Süd-Sachsen-Anhalts und Dekarbonisierung seiner chemischen Industrie – Teilvorhaben J” (funding code 031B1457J), funded by the German Federal Ministry of Education and Research (BMBF).

The author thanks the partners in the aforementioned project for their help in compiling this manuscript. Special thanks are due to Nico Tachnitz, David Anthony, Jan Lukas Wenzel und Christopher Conrad.
