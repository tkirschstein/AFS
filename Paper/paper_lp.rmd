...
The industrial ecology of biobased economies depends on one central challenge: connecting primary biological production systems to multiple industrial sectors through networks that efficiently allocate biomass fractions of varying quality to their highest-value application — the principle of industrial symbiosis applied to renewable material flows [@Hildebrandt2019].
...
[@Toensmeier2017_Carbon_Agroforestry]. This biological-industrial
...
cleaner production perspective [@Huber2018_SRAFS_growth].
...
land [@DEFAF]. This gap between potential and practice reflects an
...
material rises markedly [@Huber2018_SRAFS_growth;
@Niemczyk2021_Poplar_Rotation]. The material flow structure of an
...
[@Zahraee2020_BSC_review; @DeMeyer2016_tOPTIMASS].

This paper closes that gap by developing the **AFS Supply Chain Design
