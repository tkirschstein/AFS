...
\caption{AFS supply chain network in Saxony-Anhalt. Green polygons: potential KUP sites. Orange circles: pre-treatment facilities (sawmills and logistics hubs, radius proportional to processing capacity). Coloured squares: consumer sites (violet: chemical/pulp, blue: pulp/paper, red: energy/biogas).}\label{fig:fig-supply-chain-network}
\end{figure}
