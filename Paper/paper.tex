...
deliver substantial biomass yields while improving soil quality and
providing multiple ecosystem services compared to conventional
monocultures \citep{Huber2018_SRAFS_growth, Trnka2008_Poplar_SRF}.
...
that neglect stand growth dynamics and age-related constraints.
Moreover, downstream processing of biomasses is fairly simplified by
assuming a set of consumption sites reflecting e.g.~bioenergy plants
consuming all produced biomass quantities. Recent work has started to
...
models. Yet most applications focus on grassland or forest residues
rather than agroforestry systems with repeated coppice cycles and strong
interactions between stand structure and harvesting decisions
\citep{DeMeyer2016_tOPTIMASS}.
