...
output:
  xaringan::moon_reader:
    css: [default, talk_kirschstein_cleaned_xaringan.css]
    lib_dir: libs
    nature:
      ratio: "16:9"
...
.pull-left[
```{r fig-supply-chain-network, echo=FALSE, message=FALSE, warning=FALSE, out.width="90%"}
...
.col-50[
```{r fig-results-sc-map, echo=FALSE, message=FALSE, warning=FALSE, out.width="90%"}
