...
%\logo{\includegraphics[height=1.5ex]{ikts_logo.png}}
...
\frame[plain,label=title]{
  ...
  % Textblock-Position angepasst fuer 16:9-Format (Breite: 160mm -> x=12.5 fuer rechten Rand)
  \begin{textblock}{4}(12.5,7.5)
    \includegraphics[height=14ex]{fig/ikts_logo}
  \end{textblock}
}
