...
| 2 Pulp     | saw mills, pellet producer   | 55–75 €/t  |
| 3 Energy   | bio mass fermenters, composting facility | 30–40 €/t  |
:::
::::::
...
```{r , echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=3.75, out.width="90%", cache=TRUE}
...
ggplot(flow_df, aes(axis1 = src, axis2 = del, y = volume/1000, fill = src)) +
...
$\rightarrow$ average yearly wood production from AFS: `r round(sum(flow_df$volume)/40000)` kt  of which `r round(sum(flow_df$volume[flow_df$src == "Stems"])/40000)` kt is stem wood
