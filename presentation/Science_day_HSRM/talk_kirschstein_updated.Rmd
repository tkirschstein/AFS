...
```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", cache=TRUE}
leaflet(
...
map_sc <- leaflet(
  ...
  htmlwidgets::onRender("
    function(el, x) {
      function fixMap() {
        if (this && this.invalidateSize) {
          this.invalidateSize(true);
        }
      }
      var map = this;
      setTimeout(function(){ fixMap.call(map); }, 100);
      setTimeout(function(){ fixMap.call(map); }, 500);
      setTimeout(function(){ fixMap.call(map); }, 1200);
    }
  ")
